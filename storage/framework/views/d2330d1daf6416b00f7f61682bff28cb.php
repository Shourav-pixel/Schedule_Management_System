...
<div class="container">
    <div class="wrapper">
        <form class="form-signin"method="post" action="<?php echo e(url('studentregister-store')); ?>">
        ...
        <?php if(Session::has('err_msg')): ?>
            ...
            <div>
                ...
                <div class="login-register">
                    ...
                    <center><a href="<?php echo e(url('student-login')); ?>"><b>Login</b></a></center>
...
<?php /**PATH D:\Software Development\schedule_mangement\resources\views/login/sregister.blade.php ENDPATH**/ ?>