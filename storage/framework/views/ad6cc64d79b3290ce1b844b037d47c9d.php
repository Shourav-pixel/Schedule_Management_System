...
<div class="container">
    <div class="wrapper">
        <form class="form-signin"method="post" action="<?php echo e(url('teacherregister-store')); ?>">
        ...
        <?php if(Session::has('err_msg')): ?>
            ...
            <div>
                ...
                <div class="login-register">
                    ...
                    <center><a href="<?php echo e(url('teacher-login')); ?>"><b><h4>Login</h3></b></a></center>
...
<?php /**PATH D:\Software Development\schedule_mangement\resources\views/login/tregister.blade.php ENDPATH**/ ?>