              ...
              <div class="card mb-4">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0"><?php echo e(session('teacherid')); ?></p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0"><?php echo e(session('email')); ?></p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
                    ...
                    <div class="col-sm-9">
                      <p class="text-muted mb-0"><?php echo e(session('designation')); ?></p>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
...
<?php echo $__env->make('Teacher.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Software Development\schedule_mangement\resources\views/Teacher/pages/dashboard.blade.php ENDPATH**/ ?>