...
<body>
    <div class="container">
        <div class="wrapper">
            <form class="form-signin" method="post" action="<?php echo e(url('studentlogin-store')); ?>">
                ...
                <center>
                    <div class="d-flex justify-content-center links">
                        Don't have an account?<a href="<?php echo e(url('student-register')); ?>">Sign Up</a>
                    </div>
                </center>
            </form>
        </div>
...
<?php /**PATH D:\Software Development\schedule_mangement\resources\views/login/slogin.blade.php ENDPATH**/ ?>