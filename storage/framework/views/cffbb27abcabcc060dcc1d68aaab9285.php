...
<script>
    document.getElementById('showRoutineBtn').addEventListener('click', function() {
        ...
        if (selectedSession && selectedType && selectedSection) {
            var url = "<?php echo e(url('class-routine/:session/:semester/:section')); ?>";
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Software Development\schedule_mangement\resources\views/admin/pages/Routine/ClassRoutine/routineSession.blade.php ENDPATH**/ ?>