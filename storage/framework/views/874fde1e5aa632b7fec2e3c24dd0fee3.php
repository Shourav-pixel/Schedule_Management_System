...
<script>
    document.getElementById('showRoutineBtn').addEventListener('click', function() {
        ...
        if (selectedSession && selectedType && selectedSection) {
            var url = "<?php echo e(url('my-class/:session/:semester/:section')); ?>";
...
<?php echo $__env->make('student.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Software Development\schedule_mangement\resources\views/student/pages/MyRoutines/Class/selectSession.blade.php ENDPATH**/ ?>