...
<div class="container">
    <div class="wrapper">
        <form class="form-signin"method="post" action="<?php echo e(url('teacherlogin-store')); ?>">
            ...
            <center><div class="d-flex justify-content-center links">
					Don't have an account?<a href="<?php echo e(url('teacher-register')); ?>">Sign Up</a>
				</div></center>
...
<?php /**PATH D:\Software Development\schedule_mangement\resources\views/login/tlogin.blade.php ENDPATH**/ ?>