									...
									<div class="col-sm-4">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3 info-box-title"><?php echo e($totalStudents); ?></h1>
												<div class="mb-0">
										...
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3 info-box-title"><?php echo e($course); ?></h1>
												<div class="mb-0">
									...
									<div class="col-sm-4">
										<div class="card">
											<div class="card-body">
												...
												<h1 class="mt-1 mb-3 info-box-title"><?php echo e($teacher); ?></h1>
												<div class="mb-0">
													<span class="text-success m-r-10"><i class="material-icons col-green align-middle">trending_up</i>
														21..19%
													</span>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Software Development\schedule_mangement\resources\views/admin/pages/dashboard.blade.php ENDPATH**/ ?>