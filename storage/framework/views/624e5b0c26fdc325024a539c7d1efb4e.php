...
<script>
    document.getElementById('showRoutineBtn').addEventListener('click', function() {
        ...
        if (selectedSession && selectedType) {
            var url = "<?php echo e(url('exam-routine/:session/:type')); ?>";
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Software Development\schedule_mangement\resources\views/admin/pages/Routine/ExamRoutine/exam_session.blade.php ENDPATH**/ ?>